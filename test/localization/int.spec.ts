...
describe('Localization', () => {
  ...
  describe('Localized - Array Fields', () => {
    it('should query fields by specified locale', async () => {
      const ogDoc = await payload.create({
        locale: defaultLocale,
        collection: arrayCollectionSlug,
        data: {
          drinks: [
      ...
      const esLocalized = await payload.find({
        collection: arrayCollectionSlug,
        locale: spanishLocale,
      });

      const enLocalized = await payload.find({
        collection: arrayCollectionSlug,
        locale: defaultLocale,
      });
